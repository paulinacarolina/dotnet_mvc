// Licence file C:\Users\carol\OneDrive\Documents\ReversePOCO.txt not found.
...
namespace Platzi_Dotnet.Models
{
    ...
    public interface IDotnet : IDisposable
    {
    ...
    public class Dotnet : DbContext, IDotnet
    {
        public Dotnet()
        {
        }

        public Dotnet(DbContextOptions<Dotnet> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Data Source=.;Initial Catalog=Dotnet;Integrated Security=True;MultipleActiveResultSets=True");
            }
        }
    ...
    public class DotnetFactory : IDesignTimeDbContextFactory<Dotnet>
    {
        public Dotnet CreateDbContext(string[] args)
        {
            return new Dotnet();
        }
    }
    ...
    public class FakeDotnet : IDotnet
    {
        public DbSet<Product> Products { get; set; } // Product

        public FakeDotnet()
        {
            _database = new FakeDatabaseFacade(new Dotnet());
    ...
    public class ProductConfiguration : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.Property(x => x.Price).HasColumnName(@"Price").HasColumnType("float").HasPrecision(53).IsRequired();
